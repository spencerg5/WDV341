<?php
	...
	if( isset($_POST['prod_submit']) )
	{
		...
		if($valid_form) {
			//Form is good
			include 'connectionPDOServer.php';			//connects to the database

			$sql ="INSERT INTO lab_wagon (prod_name,prod_price,prod_color,prod_wagon ) VALUES (:prodName,:prodPrice,:prodColor,:prodWagon )"; 
			try{
